                    ...
                    <div className="p-2 max-h-72 overflow-y-auto custom-scrollbar">
                        {results.length > 0 ? (
                            results.map((user: User) => (
                                ...
                                >
                                    {/* Small Avatar */}
                                    <div className="w-11 h-11 rounded-full bg-linear-to-tr from-[#BA9EFF] to-[#43237A] flex items-center justify-center text-black font-bold text-sm border-2 border-white/5">
